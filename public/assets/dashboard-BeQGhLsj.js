...
{{contact_hs}}`}],oe=[{label:"Letter Builder",href:"/letter-builder",count:te.length},{label:"Email Builder",href:"/email-builder",count:ae.length},{label:"Invoice Builder",href:"/invoice-builder",count:re.length},{label:"Contract Builder",href:"/contract-builder",count:ne.length},{label:"Policy Builder",href:"/policy-builder",count:le.length}],se={draft:"bg-yellow-100 text-yellow-800 border-yellow-200",complete:"bg-green-100 text-green-800 border-green-200",completed:"bg-green-100 text-green-800 border-green-200",archived:"bg-gray-100 text-gray-600 border-gray-200"},de={free:0,personal:3,standard:5,professional:10,org_starter:10,org_growth:10,org_professional:10,organisation:10,business:10};function ye(){const{user:t,refreshUser:P}=Y(),[x,j]=L(),{siteName:v}=F(),[u,k]=n.useState([]),[B,E]=n.useState([]),[p,O]=n.useState(!0),[m,y]=n.useState(null),d=n.useRef(null);n.useEffect(()=>{const a=x.get("checkout"),i=x.get("plan");if(a==="success"||a==="pending"){j({},{replace:!0});const C=i?i.charAt(0).toUpperCase()+i.slice(1):"your new";y(`Welcome to the ${C} plan! Your account is being activated…`);let R=0;d.current=setInterval(()=>{R++,P(),R>=10&&(d.current&&clearInterval(d.current),y(V=>V?`Your ${C} plan is now active. Welcome aboard!`:null))},2e3)}return()=>{d.current&&clearInterval(d.current)}},[]),n.useEffect(()=>{Promise.all([W(),fetch("/api/favourites",{credentials:"include"}).then(a=>a.json())]).then(([a,i])=>{k(a),E(i.favourites??[]),O(!1)})},[]);const c=n.useMemo(()=>({total:u.length,drafts:u.filter(a=>a.status==="draft").length,completed:u.filter(a=>a.status==="complete"||a.status==="completed").length}),[u]),q=n.useMemo(()=>[...u].sort((a,i)=>new Date(i.updatedAt).getTime()-new Date(a.updatedAt).getTime()).slice(0,5),[u]),b=de[(t==null?void 0:t.plan)??"personal"]??5,w=Math.min(100,b>0?Math.round(c.drafts/b*100):0),f=w>=80;return n.useEffect(()=>{m&&(t!=null&&t.plan)&&t.plan!=="free"&&(d.current&&clearInterval(d.current),y(`Your ${t.plan.charAt(0).toUpperCase()+t.plan.slice(1)} plan is now active. Welcome aboard!`))},[t==null?void 0:t.plan,m]),e.jsxs(e.Fragment,{children:[e.jsxs(H,{children:[e.jsxs("title",{children:["Dashboard — ",v]}),e.jsx("meta",{name:"robots",content:"noindex, nofollow"})]}),e.jsx(M,{children:e.jsxs("div",{className:"p-6 max-w-7xl mx-auto space-y-6",children:[m&&e.jsxs("div",{className:"flex items-center gap-3 bg-green-50 border border-green-300 rounded-xl px-5 py-4",children:[e.jsx(N,{className:"w-5 h-5 text-green-600 shrink-0"}),e.jsx("p",{className:"text-sm font-semibold text-green-800 flex-1",children:m}),e.jsx("button",{onClick:()=>y(null),className:"text-green-600 hover:text-green-800 text-lg leading-none","aria-label":"Dismiss",children:"×"})]}),e.jsxs("div",{className:"flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4",children:[e.jsxs("div",{children:[e.jsxs("h1",{className:"text-2xl font-bold text-foreground",children:["Welcome back, ",t==null?void 0:t.firstName]}),e.jsxs("div",{className:"flex items-center gap-2 mt-1.5 flex-wrap",children:[e.jsx("p",{className:"text-muted-foreground text-sm",children:new Date().toLocaleDateString("en-GB",{weekday:"long",year:"numeric",month:"long",day:"numeric"})}),e.jsx("span",{className:"inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-0.5 rounded-full bg-primary/10 text-primary border border-primary/20",children:(t==null?void 0:t.plan)==="org_starter"?"Org Starter":(t==null?void 0:t.plan)==="org_growth"?"Org Growth":(t==null?void 0:t.plan)==="org_professional"?"Org Pro":((t==null?void 0:t.plan)??"free").charAt(0).toUpperCase()+((t==null?void 0:t.plan)??"free").slice(1)}),(t==null?void 0:t.planIsLifetime)&&e.jsx("span",{className:"inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-0.5 rounded-full bg-amber-100 text-amber-700 border border-amber-300",children:"★ Lifetime"}),(t==null?void 0:t.planExpiresAt)&&!t.planIsLifetime&&e.jsxs("span",{className:"inline-flex items-center gap-1 text-[10px] text-muted-foreground border border-border rounded-full px-2 py-0.5",children:["Expires ",new Date(t.planExpiresAt).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})]}),(t==null?void 0:t.usageType)&&t.usageType!=="both"&&e.jsx("span",{className:"inline-flex items-center gap-1 text-[10px] font-medium px-2 py-0.5 rounded-full bg-muted text-muted-foreground border border-border capitalize",children:t.usageType==="personal"?"👤 Personal":"🏢 Business"})]})]}),e.jsx(l,{asChild:!0,className:"gap-2 shrink-0",children:e.jsxs(r,{to:"/builders",children:[e.jsx(T,{className:"w-4 h-4"}),"Create Document"]})})]}),(t==null?void 0:t.usageType)==="personal"&&t.plan!=="free"&&e.jsxs("div",{className:"flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-xl px-5 py-4",children:[e.jsx(g,{className:"w-5 h-5 text-blue-600 shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm font-semibold text-blue-900",children:"Personal document templates"}),e.jsxs("p",{className:"text-xs text-blue-700 mt-0.5 leading-relaxed",children:["Your plan includes personal-use templates — tenancy agreements, personal letters, and more."," ",e.jsx(r,{to:"/builders",className:"font-semibold underline",children:"Browse builders"}),"."]})]})]}),e.jsxs("div",{className:"grid grid-cols-2 sm:grid-cols-4 gap-4",children:[e.jsx(o,{children:e.jsx(s,{className:"p-5",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-muted-foreground",children:"Saved Drafts"}),e.jsxs("p",{className:"text-3xl font-bold text-foreground mt-1",children:[p?"—":c.drafts,!p&&t&&(()=>{const i={personal:3,standard:5,professional:10,org_starter:10,org_growth:10,org_professional:10}[t.plan??"personal"]??0;return i>0?e.jsxs("span",{className:"text-base font-normal text-muted-foreground",children:["/",i]}):null})()]})]}),e.jsx("div",{className:"w-12 h-12 bg-yellow-100 rounded-xl flex items-center justify-center",children:e.jsx(ee,{className:"w-6 h-6 text-yellow-600"})})]})})}),e.jsx(o,{children:e.jsx(s,{className:"p-5",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-muted-foreground",children:"Completed"}),e.jsx("p",{className:"text-3xl font-bold text-foreground mt-1",children:p?"—":c.completed})]}),e.jsx("div",{className:"w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center",children:e.jsx(N,{className:"w-6 h-6 text-green-600"})})]})})}),e.jsx(o,{children:e.jsx(s,{className:"p-5",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-muted-foreground",children:"Favourites"}),e.jsx("p",{className:"text-3xl font-bold text-foreground mt-1",children:p?"—":B.length})]}),e.jsx("div",{className:"w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center",children:e.jsx(D,{className:"w-6 h-6 text-amber-500"})})]})})})]}),b>0&&e.jsx(o,{className:f?"border-amber-300 bg-amber-50/50":"",children:e.jsxs(s,{className:"p-4",children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(U,{className:`w-4 h-4 ${f?"text-amber-600":"text-muted-foreground"}`}),e.jsx("span",{className:"text-sm font-medium text-foreground",children:"Draft Usage"})]}),e.jsxs("span",{className:"text-sm text-muted-foreground",children:[c.drafts," / ",b," drafts"]})]}),e.jsx(X,{value:w,className:`h-2 ${f?"[&>div]:bg-amber-500":""}`}),f&&e.jsxs("p",{className:"text-xs text-amber-700 mt-2",children:["You're approaching your plan limit."," ",e.jsx(r,{to:"/pricing",className:"font-semibold underline",children:"Upgrade your plan"})," to create more documents."]})]})}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-6",children:[e.jsx("div",{className:"lg:col-span-2 space-y-6",children:e.jsxs(o,{children:[e.jsx(_,{className:"pb-3",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs(h,{className:"text-base font-semibold flex items-center gap-2",children:[e.jsx(G,{className:"w-4 h-4 text-muted-foreground"}),"Recent Documents"]}),e.jsx(l,{variant:"ghost",size:"sm",asChild:!0,children:e.jsxs(r,{to:"/documents",className:"gap-1 text-xs",children:["View all ",e.jsx(I,{className:"w-3 h-3"})]})})]})}),e.jsx(s,{children:p?e.jsx("div",{className:"space-y-2",children:[1,2,3].map(a=>e.jsx("div",{className:"h-12 bg-muted/50 rounded-lg animate-pulse"},a))}):q.length===0?e.jsxs("div",{className:"text-center py-10",children:[e.jsx(g,{className:"w-10 h-10 text-muted-foreground/40 mx-auto mb-3"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"No documents yet"}),e.jsx(l,{asChild:!0,size:"sm",className:"mt-3 gap-2",children:e.jsxs(r,{to:"/builders",children:[e.jsx(T,{className:"w-4 h-4"}),"Create your first document"]})})]}):e.jsx("div",{className:"space-y-1",children:q.map(a=>e.jsxs(r,{to:`/documents/${a.id}`,className:"flex items-center gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors group",children:[e.jsx("div",{className:"w-9 h-9 bg-primary/10 rounded-lg flex items-center justify-center shrink-0",children:e.jsx(g,{className:"w-4 h-4 text-primary"})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-sm font-medium text-foreground truncate group-hover:text-primary transition-colors",children:a.title}),e.jsxs("p",{className:"text-xs text-muted-foreground",children:[Z[a.category]," · ",K(new Date(a.updatedAt),{addSuffix:!0})]})]}),e.jsx(J,{variant:"outline",className:`text-xs shrink-0 ${se[a.status]}`,children:a.status})]},a.id))})})]})}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs(o,{children:[e.jsx(_,{className:"pb-3",children:e.jsxs(h,{className:"text-base font-semibold flex items-center gap-2",children:[e.jsx(A,{className:"w-4 h-4 text-muted-foreground"})," Quick Start"]})}),e.jsxs(s,{className:"space-y-1",children:[oe.map(a=>e.jsxs(r,{to:a.href,className:"flex items-center gap-2 p-2 rounded-md hover:bg-muted transition-colors text-sm text-muted-foreground hover:text-foreground",children:[e.jsx(g,{className:"w-4 h-4 text-primary shrink-0"}),e.jsx("span",{className:"truncate flex-1",children:a.label}),e.jsxs("span",{className:"text-[10px] text-muted-foreground shrink-0",children:[a.count," templates"]})]},a.href)),e.jsx(l,{variant:"outline",size:"sm",asChild:!0,className:"w-full mt-2 gap-2",children:e.jsxs(r,{to:"/builders",children:[e.jsx(A,{className:"w-4 h-4"}),"All builders"]})})]})]}),e.jsxs(o,{children:[e.jsx(_,{className:"pb-3",children:e.jsxs(h,{className:"text-base font-semibold flex items-center gap-2",children:[e.jsx(S,{className:"w-4 h-4 text-muted-foreground"}),"My Documents"]})}),e.jsxs(s,{className:"space-y-2",children:[e.jsxs("div",{className:"grid grid-cols-2 gap-2 text-center",children:[e.jsxs("div",{className:"bg-muted/50 rounded-lg p-3",children:[e.jsx("p",{className:"text-xl font-bold text-foreground",children:c.drafts}),e.jsx("p",{className:"text-xs text-muted-foreground mt-0.5",children:"Drafts"})]}),e.jsxs("div",{className:"bg-muted/50 rounded-lg p-3",children:[e.jsx("p",{className:"text-xl font-bold text-foreground",children:c.completed}),e.jsx("p",{className:"text-xs text-muted-foreground mt-0.5",children:"Completed"})]})]}),e.jsx(l,{variant:"outline",size:"sm",asChild:!0,className:"w-full gap-2",children:e.jsxs(r,{to:"/documents",children:[e.jsx(S,{className:"w-4 h-4"}),"View all documents"]})})]})]}),(t==null?void 0:t.plan)==="personal"&&e.jsx(o,{className:"border-primary/30 bg-primary/5",children:e.jsx(s,{className:"p-4",children:e.jsxs("div",{className:"flex items-start gap-3",children:[e.jsx(Q,{className:"w-5 h-5 text-primary shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm font-semibold text-foreground",children:"Upgrade to Professional"}),e.jsx("p",{className:"text-xs text-muted-foreground mt-1",children:"Unlock all templates, unlimited documents, and more."}),e.jsx(l,{size:"sm",className:"mt-3 w-full",asChild:!0,children:e.jsx(r,{to:"/pricing",children:"View Plans"})})]})]})})}),e.jsxs(o,{children:[e.jsx(_,{className:"pb-2",children:e.jsxs(h,{className:"text-sm flex items-center gap-2",children:[e.jsx(I,{className:"w-4 h-4 text-muted-foreground","aria-hidden":"true"}),"Quick Links"]})}),e.jsxs(s,{className:"space-y-1.5",children:[e.jsx(l,{variant:"ghost",size:"sm",asChild:!0,className:"w-full justify-start gap-2 text-muted-foreground hover:text-foreground",children:e.jsxs(r,{to:"/support",children:[e.jsx(z,{className:"w-4 h-4","aria-hidden":"true"}),"Support Centre"]})}),e.jsx(l,{variant:"ghost",size:"sm",asChild:!0,className:"w-full justify-start gap-2 text-muted-foreground hover:text-foreground",children:e.jsxs(r,{to:"/privacy-settings",children:[e.jsx($,{className:"w-4 h-4","aria-hidden":"true"}),"Privacy & Data"]})}),e.jsx(l,{variant:"ghost",size:"sm",asChild:!0,className:"w-full justify-start gap-2 text-muted-foreground hover:text-foreground",children:e.jsxs(r,{to:"/settings",children:[e.jsx(D,{className:"w-4 h-4","aria-hidden":"true"}),"Account Settings"]})})]})]})]})]}),e.jsx("div",{className:"bg-amber-50 border border-amber-200 rounded-lg p-4",children:e.jsxs("p",{className:"text-xs text-amber-800",children:[e.jsx("strong",{children:"Important:"})," Documents generated by ",v," are template-based and intended as a starting point only. They do not constitute legal advice. Users are responsible for ensuring all documents are suitable for their specific circumstances before use. Always seek professional legal advice where required."]})})]})})]})}export{ye as default};
