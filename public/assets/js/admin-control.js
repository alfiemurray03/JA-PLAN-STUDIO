...
function renderPlatformSettings(platform = {}) {
  ...
  setPanel(`
    ...
    <div class="admin-grid">
      ...
      <article class="admin-card"><h2>Email and support</h2><form class="admin-form single"><label>Enquiries mailbox<input value="japlanstudio@jagroupservices.co.uk" readonly></label><label>Telephone support<input value="020 3834 2790" readonly></label><label>Status and support pages<input value="Linked from public footer and protected admin shell" readonly></label></form></article>
