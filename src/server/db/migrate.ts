  ...
  const defaultContent: Array<{ slug: string; title: string; type: string; bodyHtml: string; bodyText: string }> = [
    {
      ...
      title: 'Homepage Hero',
      type: 'marketing',
      bodyHtml: '<h1>Create professional documents in minutes</h1><p>JA Plan Studio gives you 100+ templates for every business need — from contracts to letters, invoices to policies.</p>',
      bodyText: 'Create professional documents in minutes. JA Plan Studio gives you 100+ templates for every business need.',
    },
    {
