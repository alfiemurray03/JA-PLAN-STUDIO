...
export default function SupportChatbot() {
  ...
  function initAnon() {
    ...
    setAnonMsgs([{
      id: 'intro',
      role: 'bot',
      text: "Hi! I'm the JA Plan Studio support assistant. I'll pass your message straight to our team. What's your name?",
    }]);
    setAnonInput('');
          ...
          {isLoggedIn ? (
            ...
            <>
              ...
              <div className="px-3 py-3 border-t border-border bg-white shrink-0">
                ...
                <p className="text-[10px] text-muted-foreground text-center mt-2">Powered by JA Plan Studio Support</p>
              </div>
            </>
          )}
        </div>
