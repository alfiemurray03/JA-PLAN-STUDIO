...
const features = [
  {
    icon: FileText,
    title: 'Guided Planning Builders',
    description: 'Everyday experiences, travel, accessibility, budgets, occasions and checklists — all in one place.',
  },
  {
    icon: Zap,
    title: 'Generate in Minutes',
    description: 'Answer a few simple questions and your personalised plan is generated instantly — no specialist knowledge required.',
  },
  {
    icon: Download,
    title: 'Save, Download & Print',
    description: 'Save your plans securely, download supported outputs and return to them whenever you need them.',
  },
  {
    icon: Shield,
    title: 'Secure & Private',
    description: 'Your plans are handled with care. We operate in compliance with UK GDPR and take data protection seriously.',
  },
  {
    icon: BookTemplate,
    title: 'My Plans Library',
    description: 'Save, organise and manage your personalised planning outputs securely in one place.',
  },
  {
    icon: Lock,
    title: 'Personalised Outputs',
    description: 'Create plans shaped around your priorities, budget, accessibility needs and preferred pace.',
  },
];

const BUILDERS = [
  { icon: PenLine, label: 'Day Trip Builder', route: '/builders', color: '#1B4F8A', desc: 'Timing, activities, travel notes and budgets' },
  { icon: Users, label: 'Family Day Out Builder', route: '/builders', color: '#7c3aed', desc: 'Age-aware family plans and practical preparation' },
  { icon: Receipt, label: 'Budget Planner', route: '/builders', color: '#b45309', desc: 'Estimated, confirmed and remaining spending' },
  { icon: ClipboardList, label: 'Travel Checklist', route: '/builders', color: '#0891b2', desc: 'Reusable preparation and packing checklists' },
  { icon: Shield, label: 'Accessibility Planner', route: '/builders', color: '#16a34a', desc: 'Assistance, equipment and provider questions' },
  { icon: BarChart2, label: 'Itinerary Builder', route: '/builders', color: '#ea580c', desc: 'Clear day-by-day travel and activity planning' },
  { icon: Mail, label: 'Occasion Planner', route: '/builders', color: '#7c3aed', desc: 'Birthdays, celebrations and special occasions' },
  { icon: TrendingUp, label: 'Destination Board', route: '/builders', color: '#be185d', desc: 'Research, priorities and saved discoveries' },
  { icon: CheckSquare, label: 'Booking Tracker', route: '/builders', color: '#65a30d', desc: 'Providers, confirmations, costs and deadlines' },
  { icon: FileSignature, label: 'Holiday Planner', route: '/builders', color: '#dc2626', desc: 'One organised plan for the whole holiday' },
];
...
export default function HomePage() {
  ...
  const canonicalUrl = 'https://japlanstudio.jagroupservices.co.uk';
  const title = `${siteName} — Guided Planning Builders`;
  const description = `Create personalised everyday, travel and accessibility plans in minutes with guided builders operated by ${brandName}.`;
  ...
  return (
    <>
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <p className="text-lg text-white/80 mb-8 max-w-2xl">
                Create day-out plans, travel itineraries, accessibility checklists, budgets and more — quickly, simply and confidently. Answer a few guided questions and save your plan securely.
              </p>
      ...
      <section className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              { value: '25+', label: 'Planning Builders' },
              { value: '150+', label: 'Guides Included' },
              { value: 'PDF', label: 'Export Format' },
              { value: 'UK', label: 'Focused & Accessible' },
            ].map((stat) => (
              <div key={stat.label}>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-3">Everything you need to create better plans</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              {siteName} makes it simple to create, manage and revisit useful personalised plans without specialist knowledge.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-3">Guided builders for real-life planning</h2>
            <p className="text-muted-foreground">From local days out to complete travel preparation — shape the plan you actually need.</p>
          </div>
