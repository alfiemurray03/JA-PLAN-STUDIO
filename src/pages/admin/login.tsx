...
export default function AdminLoginPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Platform Administration — JA Plan Studio</title>
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/50 text-xs">JA Plan Studio · JA Group Services Ltd</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-10 bg-white">
          ...
          <div className="lg:hidden mb-8 text-center">
            <div className="inline-flex flex-col items-center gap-2">
              ...
              <p className="text-gray-400 text-xs">JA Plan Studio · JA Group Services Ltd</p>
            </div>
          </div>
