...
function fromRecord(record: Record<string, string>): ChatbotSettings {
  return {
    ...
    maintenanceAllowEnquiries: bool(record.ai_chatbot_maintenance_allow_enquiries, true),
...
function toRecord(settings: ChatbotSettings): Record<string, string> {
  return {
    ...
    ai_chatbot_maintenance_allow_enquiries: String(settings.maintenanceAllowEnquiries),
