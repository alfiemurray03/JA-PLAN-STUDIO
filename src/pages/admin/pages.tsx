...
const SEED_PAGES: SitePage[] = [
  ...
  { id: 'p-007', title: 'Login',               path: '/login',               category: 'auth',      status: 'live',          seoTitle: 'Sign In — JA Plan Studio', seoDescription: 'Sign in to your JA Plan Studio account.', lastUpdated: '2026-06-02', noindex: true },
